...
$BackgroundImageURL = 'https://stlcmaibuks001.blob.core.windows.net/azureimagebuilder/Images/GradientDesktopBackground.jpg'
$LockscreenImageURL = 'https://stlcmaibuks001.blob.core.windows.net/azureimagebuilder/Images/LogoBackGround_Tiny.jpg'
